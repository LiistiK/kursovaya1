...
def get_token_id(file_name):
    """Функция для чтения токена и ID пользователя из файла (записаны псстрочно)"""
...
tokenVK = 'tokenVK'  # токен и id доступа хранятся в файле
tokenYandex = 'tokenYandex'  # хранится только токен яндекс диска
